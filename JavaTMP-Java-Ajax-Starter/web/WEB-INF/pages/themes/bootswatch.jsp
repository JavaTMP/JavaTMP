    ...
    <div class="row">
        <div class="col-6 col-sm-6 col-md-4 col-lg-2 col-xl-2 text-center px-2">
            <a class="applyTheme" themeName="cerulean" href="javascript:void(0);">
                <img class="img-thumbnail" src="assets/img/themes/Cerulean.png" alt=""/>
            </a>
        </div>
        <div class="col-6 col-sm-6 col-md-4 col-lg-2 col-xl-2 text-center px-2">
            <a class="applyTheme" themeName="cosmo"  href="javascript:void(0);">
                <img class="img-thumbnail" src="assets/img/themes/Cosmo.png" alt=""/>
            </a>
        </div>
        <div class="col-6 col-sm-6 col-md-4 col-lg-2 col-xl-2 text-center px-2">
            <a class="applyTheme" themeName="cyborg"  href="javascript:void(0);">
                <img class="img-thumbnail" src="assets/img/themes/Cyborg.png" alt=""/>
            </a>
        </div>
        <div class="col-6 col-sm-6 col-md-4 col-lg-2 col-xl-2 text-center px-2">
            <a class="applyTheme" themeName="darkly"  href="javascript:void(0);">
                <img class="img-thumbnail" src="assets/img/themes/Darkly.png" alt=""/>
            </a>
        </div>
        <div class="col-6 col-sm-6 col-md-4 col-lg-2 col-xl-2 text-center px-2">
            <a class="applyTheme" themeName="flatly"  href="javascript:void(0);">
                <img class="img-thumbnail" src="assets/img/themes/Flatly.png" alt=""/>
            </a>
        </div>
        <div class="col-6 col-sm-6 col-md-4 col-lg-2 col-xl-2 text-center px-2">
            <a class="applyTheme" themeName="journal"  href="javascript:void(0);">
                <img class="img-thumbnail" src="assets/img/themes/Journal.png" alt=""/>
            </a>
        </div>
    </div>
    <div class="row mt-3">
        <div class="col-6 col-sm-6 col-md-4 col-lg-2 col-xl-2 text-center px-2">
            <a class="applyTheme" themeName="litera" href="javascript:void(0);">
                <img class="img-thumbnail" src="assets/img/themes/Litera.png" alt=""/>
            </a>
        </div>
        <div class="col-6 col-sm-6 col-md-4 col-lg-2 col-xl-2 text-center px-2">
            <a class="applyTheme" themeName="lumen"  href="javascript:void(0);">
                <img class="img-thumbnail" src="assets/img/themes/Lumen.png" alt=""/>
            </a>
        </div>
        <div class="col-6 col-sm-6 col-md-4 col-lg-2 col-xl-2 text-center px-2">
            <a class="applyTheme" themeName="lux"  href="javascript:void(0);">
                <img class="img-thumbnail" src="assets/img/themes/Lux.png" alt=""/>
            </a>
        </div>
        <div class="col-6 col-sm-6 col-md-4 col-lg-2 col-xl-2 text-center px-2">
            <a class="applyTheme" themeName="materia"  href="javascript:void(0);">
                <img class="img-thumbnail" src="assets/img/themes/Materia.png" alt=""/>
            </a>
        </div>
        <div class="col-6 col-sm-6 col-md-4 col-lg-2 col-xl-2 text-center px-2">
            <a class="applyTheme" themeName="minty"  href="javascript:void(0);">
                <img class="img-thumbnail" src="assets/img/themes/Minty.png" alt=""/>
            </a>
        </div>
        <div class="col-6 col-sm-6 col-md-4 col-lg-2 col-xl-2 text-center px-2">
            <a class="applyTheme" themeName="pulse"  href="javascript:void(0);">
                <img class="img-thumbnail" src="assets/img/themes/Pulse.png" alt=""/>
            </a>
        </div>
    </div>
    <div class="row mt-3">
        <div class="col-6 col-sm-6 col-md-4 col-lg-2 col-xl-2 text-center px-2">
            <a class="applyTheme" themeName="sandstone" href="javascript:void(0);">
                <img class="img-thumbnail" src="assets/img/themes/Sandstone.png" alt=""/>
            </a>
        </div>
        <div class="col-6 col-sm-6 col-md-4 col-lg-2 col-xl-2 text-center px-2">
            <a class="applyTheme" themeName="simplex"  href="javascript:void(0);">
                <img class="img-thumbnail" src="assets/img/themes/Simplex.png" alt=""/>
            </a>
        </div>
        <div class="col-6 col-sm-6 col-md-4 col-lg-2 col-xl-2 text-center px-2">
            <a class="applyTheme" themeName="sketchy"  href="javascript:void(0);">
                <img class="img-thumbnail" src="assets/img/themes/Sketchy.png" alt=""/>
            </a>
        </div>
        <div class="col-6 col-sm-6 col-md-4 col-lg-2 col-xl-2 text-center px-2">
            <a class="applyTheme" themeName="slate"  href="javascript:void(0);">
                <img class="img-thumbnail" src="assets/img/themes/Slate.png" alt=""/>
            </a>
        </div>
        <div class="col-6 col-sm-6 col-md-4 col-lg-2 col-xl-2 text-center px-2">
            <a class="applyTheme" themeName="solar"  href="javascript:void(0);">
                <img class="img-thumbnail" src="assets/img/themes/Solar.png" alt=""/>
            </a>
        </div>
        <div class="col-6 col-sm-6 col-md-4 col-lg-2 col-xl-2 text-center px-2">
            <a class="applyTheme" themeName="spacelab"  href="javascript:void(0);">
                <img class="img-thumbnail" src="assets/img/themes/Spacelab.png" alt=""/>
            </a>
        </div>
    </div>
    <div class="row mt-3">
        <div class="col-6 col-sm-6 col-md-4 col-lg-2 col-xl-2 text-center px-2">
            <a class="applyTheme" themeName="superhero" href="javascript:void(0);">
                <img class="img-thumbnail" src="assets/img/themes/Superhero.png" alt=""/>
            </a>
        </div>
        <div class="col-6 col-sm-6 col-md-4 col-lg-2 col-xl-2 text-center px-2">
            <a class="applyTheme" themeName="united"  href="javascript:void(0);">
                <img class="img-thumbnail" src="assets/img/themes/United.png" alt=""/>
            </a>
        </div>
        <div class="col-6 col-sm-6 col-md-4 col-lg-2 col-xl-2 text-center px-2">
            <a class="applyTheme" themeName="yeti"  href="javascript:void(0);">
                <img class="img-thumbnail" src="assets/img/themes/Yeti.png" alt=""/>
            </a>
        </div>
    </div>
    <style type="text/css">
        ...
        jQuery(function ($) {
            ...
            $(javatmp.settings.defaultOutputSelector).on(javatmp.settings.javaTmpAjaxContainerReady, function (event) {
                ...
                $(".applyTheme").on("click", function () {
                    ...
                    var newUrl = "assets/dist/css/javatmp-" + themeName + ".min.css";
