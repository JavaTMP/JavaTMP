...
<div class="dynamic-ajax-content pt-3">
    <div class="d-flex flex-row flex-wrap flex-sm-wrap flex-md-wrap flex-lg-nowrap flex-xl-nowrap justify-content-center align-content-center">
        ...
        <button type="button" class="logout-home-btn-id javatmp-btn btn btn-primary m-3"
    ...
    <div class="d-flex flex-row flex-wrap flex-sm-wrap flex-md-wrap flex-lg-nowrap flex-xl-nowrap justify-content-center align-content-center">
        <button type="button" class="javatmp-btn btn btn-primary btn-block m-3"
    ...
    <div class="d-flex flex-row flex-wrap flex-sm-wrap flex-md-wrap flex-lg-nowrap flex-xl-nowrap justify-content-center align-content-center">
        ...
        <button type="button" class="javatmp-btn btn btn-primary m-3"
                actionType="action-ref-href" action-ref-by-href="${pageContext.request.contextPath}/pages/custom-components/layout-options" >
            <i class="fas fa-coffee"></i>
            Layout Options
        </button>
    </div>
