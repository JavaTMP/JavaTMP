                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal">
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <input id="alert_message" type="text" class="form-control"
                                       value="Dynamic Alert text ..." placeholder="enter a text ..."> </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="alert_close" class="col-md-3 control-label">Closable ?</label>
                            <div class="col-md-7">
                                <div class="checkbox">
                                    <label>
                                        <input checked="" class="" id="alert_close" name="" type="checkbox"/>
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="alert_reset" class="col-md-3 control-label">Close All Previouse Alerts ?</label>
                            <div class="col-md-7">
                                <div class="checkbox">
                                    <label>
                                        <input class="" id="alert_reset" name="" type="checkbox"/>
                                    </label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="alert_focus" class="col-md-3 control-label">Auto Scroll/Focus ?</label>
                            <div class="col-md-7">
                                <div class="checkbox">
                                    <label>
                                        <input class="" id="alert_focus" name="" type="checkbox"/>
                                    </label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label" for="alert_close_in_seconds">Auto Close In(seconds):</label>
                            <div class="col-md-5">
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label" for="title">Font Awesome Icon:</label>
                            <div class="col-md-5">
                                <select id="alert_icon" class="form-control input-medium">
                                    <option value="" selected="selected">none</option>
                                    <option value="fa-lg fa fa-warning">fa-lg fa fa-warning</option>
