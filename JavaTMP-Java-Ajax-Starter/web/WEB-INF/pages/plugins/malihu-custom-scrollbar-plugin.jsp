...
<div class="dynamic-ajax-content">
    ...
    <style type="text/css">
        ...
        */
        ...
        .snap-scrolling-example .mCSB_container{
            display: -webkit-flex;
            display: flex;
            /*flex-wrap: nowrap;*/
        }

        .horizontal-images.content img{ height: 160px; }
        ...
        .horizontal-images.content .item{
...
//                            $("#infinite-scroll").mCustomScrollbar('scrollTo', 'bottom', {scrollInertia: 20});
            ...
            function addContent(el) {
                ...
                $(".fetch-indicator").appendTo(el.mcs.content);
            }
