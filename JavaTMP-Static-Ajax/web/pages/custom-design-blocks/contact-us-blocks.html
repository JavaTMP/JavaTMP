        ...
        <div class="col-lg-12">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-12 col-md-6 col-lg-5">
                            ...
                            <p>
                                <a href="javascript:;">support@javatmp.com</a>
                            </p>
                        </div>
                        <div class="col-12 col-md-6 ml-auto">
                            ...
                            <form>
                                ...
                                <div class="row mt-4">
                                    <div class="col">
                                        <textarea class="form-control" name="message" rows="5" placeholder="How can we help?" style="margin-top: 0px; margin-bottom: 0px; height: 273px;"></textarea>
                                    </div>
                                </div>
                                <div class="row mt-4">
                                    <div class="col">
            ...
            <section class="pt-5 pb-0">
                            ...
                            <form>
                                ...
                                <div class="row mt-4">
                                    <div class="col">
                                        ...
                                        <textarea class="form-control" name="message" rows="3" style="margin-top: 0px; margin-bottom: 0px; height: 86px;"></textarea>
                                    </div>
                                </div>
                                <div class="row mt-4">
                ...
                <div class="container-fluid p-0 mt-5">
                    <iframe class="map" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d13276.130589485732!2d-122.42226015576097!3d37.76700381519751!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8085809c6c8f4459%3A0xb10ed6d9b5050fa5!2sTwitter+HQ!5e0!3m2!1sru!2sru!4v1532164770673"
            ...
            <section class="pb-5 pt-0">
                ...
                <div class="container">
                    <div class="row mt-5">
                        <div class="col-12 col-md-6 col-lg-5">
                            <h2>Contact Us</h2>
                            <p class="text-h3">Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus. Fusce dapibus, tellus ac cursus commodo.</p>
                            <p class="text-h3">Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh.</p>
                            <p class="text-h3 mt-5">
                                <strong>Email:</strong>
                                <a href="javascript:;">hello@website.com</a>
                            </p>
                            <p class="text-h3">
                                <strong>Phone:</strong>
                                <a href="javascript:;">+44 123 123 1232</a>
                            </p>
                        </div>
                        <div class="col-12 col-md-6 ml-auto pt-5 pt-md-0">
                            <form>
                                ...
                                <div class="row mt-4">
                                    <div class="col">
                                        <textarea class="form-control" name="message" rows="3" placeholder="How can we help?" style="margin-top: 0px; margin-bottom: 0px; height: 107px;"></textarea>
                                    </div>
                                </div>
                                <div class="row mt-4">
                                    <div class="col">
            ...
            <hr/>
            <section class="pb-5 pt-5 bg-dark text-light">
                <div class="container">
                    <div class="row text-center justify-content-center">
                        <div class="col-12 col-md-8 col-lg-7">
                            <h1>Contact Us</h1>
                    ...
                    <div class="row pt-4">
                        <div class="col-12">
                            <form>
                                ...
                                <div class="row mt-4">
                                    <div class="col">
                                        <textarea class="form-control" name="message" rows="3" placeholder="How can we help?" style="margin-top: 0px; margin-bottom: 0px; height: 197px;"></textarea>
                                    </div>
                                </div>
                                <div class="row mt-4">
            ...
            <section class="pt-5 pb-5">
                <div class="container">
                    <div class="row">
                        <div class="col-md-6 ">
                            <img src="http://via.placeholder.com/550x450/ccc/ffffff" alt="" class="img-fluid m-shadow-16 rounded shadow">
                        </div>
                        <div class="col-md-6">
                            <div class="card-body">
                                <h2 class="display-5 mt-2">Why not shoot us a mail?</h2>
                                <p>We'd love to hear from you. From anyone, really. It's lonely over here.</p>
                                <form class="form">
                                    <div class="form-group">
                                        <select class="form-control" id="subject" name="subject">
                                            <option disabled="" selected="" value="">Select the subject of your message *</option>
            ...
            <section class="pt-0 pb-0">
                <div class="container-fluid m-0 ">
                    <div class="row d-md-flex-row  overflow-hidden">
                        <div class="col-md-8   pb-5 overflow-hidden bg-light">
                            <div class="p-md-5 p-4 ml-md-5">
                                <h1 class="  mb-0 mt-md-5 pt-sm-4">Request a quote</h1>
                            </div>
                                ...
                                <div class="row  justify-content-center">
                                    <div class="col-md-10">
                                        <form>
                                            ...
                                            <div class="row mt-4">
                                                <div class="col">
                                                    <button type="submit" class="btn btn-dark shadow-lg btn-lg">Send request</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
