...
/*! Extension 'jquery.fancytree.multi.min.js' */!function(e){"function"==typeof define&&define.amd?define(["jquery","./jquery.fancytree"],e):"object"==typeof module&&module.exports?(require("./jquery.fancytree"),module.exports=e(require("jquery"))):e(jQuery)}(function(e){"use strict";return e.ui.fancytree.registerExtension({name:"multi",version:"2.30.0",options:{allowNoSelect:!1,mode:"sameParent"},treeInit:function(t){this._superApply(arguments),this.$container.addClass("fancytree-ext-multi"),1===t.options.selectMode&&e.error("Fancytree ext-multi: selectMode: 1 (single) is not compatible.")},nodeClick:function(t){var i=t.tree,n=t.node,r=i.getActiveNode()||i.getFirstChild(),c="checkbox"===t.targetType,o="expander"===t.targetType;switch(e.ui.fancytree.eventToString(t.originalEvent)){case"click":if(o)break;c||(i.selectAll(!1),n.setSelected());break;case"shift+click":i.visitRows(function(e){if(e.setSelected(),e===n)return!1},{start:r,reverse:r.isBelowOf(n)});break;case"ctrl+click":case"meta+click":return void n.toggleSelected()}return this._superApply(arguments)},nodeKeydown:function(t){var i=t.tree,n=t.node;switch(e.ui.fancytree.eventToString(t.originalEvent)){case"up":case"down":i.selectAll(!1),n.navigate(event.which,!0),i.getActiveNode().setSelected();break;case"shift+up":case"shift+down":n.navigate(event.which,!0),i.getActiveNode().setSelected()}return this._superApply(arguments)}}),e.ui.fancytree});
