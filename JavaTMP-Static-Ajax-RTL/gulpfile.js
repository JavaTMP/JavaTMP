...
gulp.task('main-sass', ["delete-css"], function () {
    return gulp.src([
        './public_html/assets/src/sass/main.scss',
        './public_html/assets/src/sass-rtl/main-rtl.scss'
    ])
...
gulp.task('plugins-sass', ["main-sass"], function () {
    return gulp.src([
        './public_html/assets/src/sass/plugins/**/*.scss',
        './public_html/assets/src/sass-rtl/plugins-rtl/**/*.scss'
    ])
            .pipe(sass().on('error', sass.logError))
            .pipe(autoprefixer({
                browsers: ['last 2 versions'],
...
gulp.task('pages-sass', ["plugins-sass"], function () {
    return gulp.src([
        './public_html/assets/src/sass/pages/**/*.scss',
        './public_html/assets/src/sass-rtl/pages-rtl/**/*.scss'
    ])
            .pipe(sass().on('error', sass.logError))
            .pipe(autoprefixer({
                browsers: ['last 2 versions'],
...
gulp.task('watch-sass-and-js', ["delete-css", "delete-js", "sass", "compress-js"], function () {
    ...
    gulp.watch('./public_html/assets/src/sass-rtl/**/*.scss', ['sass']);
