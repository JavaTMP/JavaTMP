...
public class Asn1StructureTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(new String(os_encoded, StandardCharsets.US_ASCII));
        System.out.println("================== ");
        byte[] os_octects = os.getOctets();
        System.out.println(new String(os_octects, StandardCharsets.US_ASCII));
        ...
        System.out.println(new String(os2_encoded, StandardCharsets.US_ASCII));
        ...
        System.out.println(new String(gs_encoded, StandardCharsets.US_ASCII));
        ...
        System.out.println(new String(utf8s_encoded, StandardCharsets.US_ASCII));
