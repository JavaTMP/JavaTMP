...
public class X509V3CreateExample {
    ...
    public static X509Certificate selfSign(KeyPair keyPair)
        ...
        BigInteger certSerialNumber = new BigInteger(Long.toString(
                now)); // <-- Using the current timestamp as the certificate serial number
        ...
        BasicConstraints basicConstraints = new BasicConstraints(
                true); // <-- true for CA, false for EndEntity
