...
public class Pkcs10 {
    ...
    public static PKCS10CertificationRequest createPkcs10RequestWithSubjectAltName()
        ...
        Extension subjectAltName = new Extension(
                Extension.subjectAlternativeName, false,
                new DEROctetString(new GeneralNames(
                        new GeneralName(new X500Name("CN=Alt Name")))));
    ...
    public static boolean verifyPkcs10Request(
    ...
    public static void main(String[] args)
        ...
        System.err.println(GeneralNames.getInstance(requestExtensions
                .getExtensionParsedValue(Extension.subjectAlternativeName)));
    }
}
