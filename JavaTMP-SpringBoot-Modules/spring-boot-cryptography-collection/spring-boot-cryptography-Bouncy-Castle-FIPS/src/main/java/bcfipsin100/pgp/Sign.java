...
public class Sign {
    public static byte[] createSignedObject(int signingAlg,
    ...
    public static boolean verifySignedObject(PGPPublicKey verifyingKey,
        ...
        PGPOnePassSignatureList onePassList = (PGPOnePassSignatureList) pgpFact
                .nextObject();
        ...
        ops.init(new JcaPGPContentVerifierBuilderProvider()
                .setProvider("BCFIPS"), verifyingKey);
    ...
    public static byte[] createDetachedSignature(int signingAlg,
                                                 PGPPrivateKey signingKey,
                                                 byte[] data)
            throws PGPException, IOException {
        ByteArrayOutputStream bOut = new ByteArrayOutputStream();
    ...
    public static boolean verifyDetachedSignature(PGPPublicKey verifyingKey,
                                                  byte[] pgpSignature,
                                                  byte[] data)
            throws PGPException, IOException {
    ...
    public static void main(String[] args)
        ...
        PGPKeyPair pgpKeyPair = new JcaPGPKeyPair(PublicKeyAlgorithmTags.ECDSA,
                signKeyPair, new Date());

        System.err.println(verifySignedObject(pgpKeyPair.getPublicKey(),
                createSignedObject(PublicKeyAlgorithmTags.ECDSA,
                        pgpKeyPair.getPrivateKey(), ExValues.SampleInput)));
        System.err.println(verifyDetachedSignature(pgpKeyPair.getPublicKey(),
                createDetachedSignature(PublicKeyAlgorithmTags.ECDSA,
                        pgpKeyPair.getPrivateKey(), ExValues.SampleInput),
