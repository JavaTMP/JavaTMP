...
public class Shs {
    ...
    public static byte[] calculateShakeOutput(byte[] data)
        ...
        OutputXOFCalculator<FipsSHS.Parameters> calculator = factory
                .createOutputXOFCalculator(FipsSHS.SHAKE256);
    ...
    public static byte[] calculateShakeOutputContinuous(byte[] data)
        ...
        return Arrays.concatenate(calculator.getFunctionOutput(16),
                calculator.getFunctionOutput(16));
    }
    ...
    public static void main(String[] args)
        ...
        System.err.println("Digest       : " +
                Hex.toHexString(calculateDigest(ExValues.SampleInput)));

        System.err.println("Digest (SHA3): " +
                Hex.toHexString(calculateSha3Digest(ExValues.SampleInput)));

        SecretKey hmacKey = generateKey();

        System.err.println("HMAC: " +
                Hex.toHexString(calculateHmac(hmacKey, ExValues.SampleInput)));

        System.err.println("SHAKE:              " +
                Hex.toHexString(calculateShakeOutput(ExValues.SampleInput)));

        System.err.println("SHAKE (continuous): " +
                Hex.toHexString(calculateShakeOutputContinuous(ExValues.SampleInput)));
    }
}
