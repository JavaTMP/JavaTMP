...
public class Drbg {
    public static void setDefaultDrbg() {
        EntropySourceProvider entSource = new BasicEntropySourceProvider(
        ...
        CryptoServicesRegistrar
                .setSecureRandom(drgbBldr.build(ExValues.Nonce, false));
    }
    ...
    public static SecureRandom buildDrbg() {
        ...
        FipsDRBG.Builder drgbBldr = FipsDRBG.SHA512_HMAC
