...
+---[JavaTMP-Static-Ajax](http://demo.javatmp.com/JavaTMP-Static-Ajax/ "Java Bootstrap Admin And Dashboard Components Template") (Static LTR/RTL Bootstrap Admin and Dashboard components template)
```
...
|---readme.md (read me file)
|---LICENSE (end-user license agreement (EULA) and copyright information file)
+---[JavaTMP-User-Starter](http://java.javatmp.com:8080/JavaTMP-User-Starter/ "Dynamic Java Bootstrap LTR/RTL multi languages User Management Web application Template") (Dynamic LTR/RTL multi languages Advanced Java Bootstrap User Management Web application version)
```
