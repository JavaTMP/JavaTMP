...
else case when BS_Category_VC not in ('FA_Cost','FA','CA','Cos','Otc','Tax') and Amount_NU < 0 then (Amount_NU * -1) else 0 end end) as 'Debit Bal',
 sum(case when BS_Category_VC in ('FA_Cost','FA','CA','Cos','Otc','Tax') and Amount_NU < 0 then (Amount_NU * -1)
else case when BS_Category_VC not in ('FA_Cost','FA','CA','Cos','Otc','Tax') and Amount_NU > 0 then (Amount_NU) else 0 end end) as 'Credit Bal'
