...
*   Read more about `javatmp.init` Javascript function in the following page : [Frameworks And Plugins Files](/pages/javatmp-frontend-frameworks-and-plugins-files "JavaTMP Front-end Frameworks and Plugins Files").
