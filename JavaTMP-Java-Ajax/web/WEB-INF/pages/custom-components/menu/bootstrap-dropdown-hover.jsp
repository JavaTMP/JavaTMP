    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="alert alert-info">
                <p>Note that we use a timer with 200ms to wait when mouse leave event on <code>.dropdown</code> or <code>.btn-group</code> to remove any flutter.
                    However, You can remove listening on <code>mouseleave</code> event and make dropdown work as default instead of hiding it automatically.</p>
            </div>
            <div class="card my-3">
