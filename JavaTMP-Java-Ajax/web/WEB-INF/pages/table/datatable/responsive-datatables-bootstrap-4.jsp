...
<div class="dynamic-ajax-content">
    <div class="row">
        <div class="col-lg-12">
            <div class="alert alert-info my-3">
                ...
                <br/>
                <p>
                    <a class="btn btn-info" target="_blank" href="https://datatables.net/extensions/responsive/">
            ...
            <div id="table-panel" class="card my-3">
                <div class="card-header">
                    Responsive Datatables by collapsing details
                ...
                <div class="card-body">
                    <table width="100%" cellspacing="0" class="table table-striped table-bordered table-hover" id="responsive-dataTables-example">
                        <thead>
                            <tr>
                                <th>Name</th>
                                <th>Position</th>
            ...
            <div class="card my-3">
                <div class="card-header">
                    Responsive Datatables by modal dialog
                    <div class="options float-right">
                        <a class="settings"><i class="fa fa-cog"></i></a>
                        <a href="#" class="collapse"><i class="fa fa-chevron-up"></i></a>
                        <a href="#" class="reload"><i class="fa fa-sync"></i></a>
    ...
    <script type="text/javascript">
        jQuery(function ($) {
            ...
            var table = $('#responsive-dataTables-example').DataTable({
                responsive: true
            });
