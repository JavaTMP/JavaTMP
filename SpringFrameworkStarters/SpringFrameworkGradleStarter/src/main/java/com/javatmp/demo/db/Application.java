...
//    @Autowired
    ...
    public static void main(String[] args) throws IOException {
        ...
        ctx.register(com.javatmp.demo.rest.RestTemplateApplication.class);
        ctx.refresh();
        com.javatmp.demo.rest.RestTemplateApplication bean = ctx.getBean(com.javatmp.demo.rest.RestTemplateApplication.class);
        bean.run();
