package com.javatmp.demo.db.config;
...
public class AppPU1Config {
    ...
    public static final String BASE_PACKAGES = "com.javatmp.demo.db.repository1";
...
//        factory.setPackagesToScan("com.javatmp.demo.db.repository");
