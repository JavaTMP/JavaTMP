...
public class AppPUConfig {
    ...
    public static final String ENTITY_MANAGER_FACTORY_REF = "AppPUEntityManagerFactory";
    public static final String TRANSACTION_MANAGER_REF = "entityManagerTransactionManager";

    @Bean(name = AppPUConfig.ENTITY_MANAGER_FACTORY_REF)
...
//        properties.setProperty("javax.persistence.schema-generation.database.action", "create");
        ...
        factory.setPersistenceUnitName("AppPU");
        return factory;
    }

    @Bean(name = AppPUConfig.TRANSACTION_MANAGER_REF)
    PlatformTransactionManager createTransactionManager(
            @Qualifier(AppPUConfig.ENTITY_MANAGER_FACTORY_REF)
