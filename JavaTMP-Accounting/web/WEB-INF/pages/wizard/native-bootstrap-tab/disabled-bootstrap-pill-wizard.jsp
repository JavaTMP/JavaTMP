                    ...
                    <div class="mt-3 row bootstrap-pill-wizard">
                        <div class="col-12">
                            <div class="nav nav-pills nav-justified" id="v-pills-tab1" role="tablist" aria-orientation="vertical">
                                <a class="disabled nav-item nav-link" id="step1-1" data-toggle="pill" href="#v-pills-home1" role="tab" aria-controls="v-pills-home" aria-selected="true">Step 1</a>
                                <a class="disabled nav-item nav-link" id="step2-1" data-toggle="pill" href="#v-pills-profile1" role="tab" aria-controls="v-pills-profile" aria-selected="false">Step 2</a>
                                <a class="disabled nav-item nav-link" id="step3-1" data-toggle="pill" href="#v-pills-messages1" role="tab" aria-controls="v-pills-messages" aria-selected="false">Step 3</a>
                                <a class="disabled nav-item nav-link" id="step4-1" data-toggle="pill" href="#v-pills-settings1" role="tab" aria-controls="v-pills-settings" aria-selected="false">Step 4</a>
                            </div>
                        </div>
                        <div class="col-12">
