...
<div class="dynamic-ajax-content">
    <div class="page-header">
        <h1>Horizontal Bootstrap Pill Wizard</h1>
    </div>
    <div class="row">
        <div class="col">
            <div class="card my-3">
                ...
                <div class="card-body">
                    <a href="#myModal" role="button" class="btn btn-primary btn-lg" data-toggle="modal">Start Horizontal</a>
