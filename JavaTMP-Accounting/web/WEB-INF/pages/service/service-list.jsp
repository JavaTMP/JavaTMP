            ...
            <div class="card">
                ...
                <div class="card-body p-1">
                    <table cellspacing="0" class="table table-condensed table-bordered table-hover" id="list">
                        <thead>
                            <tr>
                                <th style="width: 8rem;"><p class="m-0 p-0" style="width: 8rem;">Service ID</p></th>
                                <th style="width: 25rem;"><p class="m-0 p-0" style="width: 25rem;">Service Name</p></th>
                            </tr>
                        </thead>
                        <tbody></tbody>
                    </table>
    ...
    <script type="text/javascript">
        ...
        jQuery(function ($) {
            ...
            var table = listTableElement.DataTable({
                ...
                "ajax": {
                    "type": "POST",
                    "url": javatmp.settings.contextPath + "/service/ListServices",
                    dataType: "json",
            ...
            addNewPopupButton.on("click", function (event) {
                BootstrapModalWrapperFactory.createAjaxModal({
                    ...
                    //                        size: "modal-lg",
                    url: javatmp.settings.contextPath + "/service/AddNewServicePopup",
            ...
            deleteSelectedButton.on("click", function (event) {
                ...
                if (selectedData.length > 0) {
                    ...
                    window.javatmp.plugins.confirmAjaxAction(
                            ...
                            "Are You Sure You want to delete selected Service ?",
                            "Delete Service",
                            javatmp.settings.labels["global.cancel"],
                            javatmp.settings.contextPath + "/service/DeleteService",
                            selectedRecord,
                            function (data) {
                                table.columns.adjust().draw();
                            }
