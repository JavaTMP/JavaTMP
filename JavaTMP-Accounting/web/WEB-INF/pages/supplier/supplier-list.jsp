...
<div class="dynamic-ajax-content grid-gutter-padding">
    <h5 class="my-3">Supplier List</h5>
    <hr/>
    <div class="row">
        <div class="col">
            <div class="card">
                ...
                <div class="card-body p-1">
                    <table cellspacing="0" class="table table-condensed table-bordered table-hover" id="list">
                        <thead>
                            <tr>
                                <th style="width: 8rem;"><p class="m-0 p-0" style="width: 8rem;">Supplier ID</p></th>
                                <th style="width: 25rem;"><p class="m-0 p-0" style="width: 25rem;">Supplier Name</p></th>
                            </tr>
                        </thead>
                        <tbody></tbody>
                    </table>
    ...
    <script type="text/javascript">
        ...
        jQuery(function ($) {
            ...
            var table = listTableElement.DataTable({
                ...
                "ajax": {
                    "type": "POST",
                    "url": javatmp.settings.contextPath + "/supplier/ListSuppliers",
                    dataType: "json",
            ...
            addNewPopupButton.on("click", function (event) {
                BootstrapModalWrapperFactory.createAjaxModal({
                    ...
                    //                        size: "modal-lg",
                    url: javatmp.settings.contextPath + "/supplier/AddNewSupplierPopup",
            ...
            deleteSelectedButton.on("click", function (event) {
                ...
                if (selectedData.length > 0) {
                    ...
                    window.javatmp.plugins.confirmAjaxAction(
                            ...
                            javatmp.settings.contextPath + "/supplier/DeleteSupplier",
                            selectedRecord,
                            function (data) {
                                table.columns.adjust().draw();
                            }
