...
<div class="dynamic-ajax-content grid-gutter-padding">
    <div class="row">
        <div class="col-lg-12">
            <form accept-charset="UTF-8" autocomplete="off" id="addNewObjectPopup" class="form"
                  action="${pageContext.request.contextPath}/fixedAsset/AddNewFixedAssetPopup" method="post" novalidate="novalidate">
                <div class="form-row">
                    <div class="col-lg-12">
                        <div class="form-group form-row">
                            <label class="text-sm-right control-label col-sm-5 col-form-label">FixedAsset Name</label>
                            <div class="col-sm-7">
...
//            console.log(currentParentModal.options.id);
        $("#" + currentParentModal.options.id).on(javatmp.settings.javaTmpAjaxContainerReady, function (event, modal) {
            ...
            var form = $('#addNewObjectPopup');
            var validator = null;

            modal.updateTitle("Add New FixedAsset");
