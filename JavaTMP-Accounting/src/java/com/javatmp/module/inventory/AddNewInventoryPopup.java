...
@WebServlet("/inventory/AddNewInventoryPopup")
public class AddNewInventoryPopup extends HttpServlet {

    private final Logger logger = Logger.getLogger(getClass().getName());

    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        String requestPage = "/WEB-INF/pages/inventory/addNewInventoryPopup.jsp";
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            Inventory toBeCreated = new Inventory();
            ...
            inventoryService.createNewInventory(toBeCreated);
