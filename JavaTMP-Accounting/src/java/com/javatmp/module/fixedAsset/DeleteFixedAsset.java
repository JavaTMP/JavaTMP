...
@WebServlet("/fixedAsset/DeleteFixedAsset")
public class DeleteFixedAsset extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            FixedAsset reqObject = (FixedAsset) MvcHelper.readObjectFromRequest(request, FixedAsset.class);

            int updateStatus = fixedAssetService.deleteFixedAsset(reqObject);
