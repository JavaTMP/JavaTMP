...
@WebServlet("/supplier/DeleteSupplier")
public class DeleteSupplier extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            Supplier reqObject = (Supplier) MvcHelper.readObjectFromRequest(request, Supplier.class);

            int updateStatus = supplierService.deleteSupplier(reqObject);
