...
<div class="dynamic-ajax-content grid-gutter-padding">
    <h4 class="my-3">Animate.css Plugin</h4>
    <hr/>
    <div class="row">
        <div class="col-lg-12">
            <div class="alert alert-info">
                <p>A cross-browser library of CSS animations. As easy to use as an easy thing.</p>
                <p>
                    <a class="btn btn-info" target="_blank" href="https://daneden.github.io/animate.css/">Demo Page</a>
                    <a class="btn btn-info" target="_blank" href="https://github.com/daneden/animate.css">github.com Project Link</a>
                </p>
            </div>
            <div class="card my-3">
                <div class="card-body">
    ...
    <script type="text/javascript">
        ...
        jQuery(function ($) {
            ...
            // <--- HERE --->
            //
//            $('[mouseleaveRemove]').on("mouseleave", function () {
//                if (!$(this).data("active") || $(this).data("active") === false) {
//                    $(this).removeClass($(this).attr("mouseleaveRemove"));
//                    $(this).removeData("active");
//                } else {
//                    console.log("do nothing on mouseleave");
//                    $(this).one("animationend transitionend webkitAnimationEnd oanimationend MSAnimationEnd webkitTransitionEnd otransitionend oTransitionEnd msTransitionEnd", function () {
//                        $(this).off("animationend transitionend webkitAnimationEnd oanimationend MSAnimationEnd webkitTransitionEnd otransitionend oTransitionEnd msTransitionEnd");
...
//                }
//            });
            $('[mouseenterAdd]').on("mouseenter", function (event) {
                console.log("mouse enter");
                if ($(this).hasClass($(this).attr("mouseenterAdd")) === false) {
                    if (!$(this).data("active") || $(this).data("active") === false) {
                        ...
                        $(this).one("webkitAnimationEnd mozAnimationEnd oAnimationEnd animationEnd", function () {
                            ...
                            $(this).data("active", false);
                            $(this).removeClass($(this).attr("mouseleaveRemove"));
                        }).addClass($(this).attr("mouseenterAdd"));
                    } else {
                        console.log("do nothing on mouseenter");
                    }
                } else {
                    console.log("has already classes");
                }
