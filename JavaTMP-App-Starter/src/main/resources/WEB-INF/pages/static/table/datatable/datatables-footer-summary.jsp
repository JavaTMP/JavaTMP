    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="alert alert-info mt-3">
                ...
                <br/>
                <p>
                    <a class="btn btn-info" target="_blank" href="https://datatables.net/examples/advanced_init/footer_callback.html">
    ...
    <script type="text/javascript">
        jQuery(document).ready(function () {
            (function ($) {
                ...
                $(javatmp.settings.defaultOutputSelector).on(javatmp.settings.javaTmpAjaxContainerResizeEventName, function () {
                    table.columns.adjust().draw();
//                    table.fixedHeader.adjust();
                });

                $("#table-panel").on("panel.fullscreen.compress panel.fullscreen.expand", function (event) {
                    table.columns.adjust().draw();
                });
