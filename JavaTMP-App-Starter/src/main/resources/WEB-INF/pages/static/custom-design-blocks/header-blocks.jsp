        ...
        <div class="col-lg-12">
                    ...
                    <div class="collapse navbar-collapse justify-content-md-center" id="navbarsExample10">
                        <ul class="navbar-nav">
                            <li class="nav-item active">
                                <a class="nav-link" href="javascript:;">Centered nav only <span class="sr-only">(current)</span></a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="javascript:;" id="dropdown10" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Dropdown</a>
            ...
            <nav class="navbar navbar-dark navbar-expand-md">
                ...
                <div class="collapse navbar-collapse" id="navbarNav9">
                    ...
                    <a class="btn bg-white  btn-light ml-md-3" href="javascript:;">Button</a>
                </div>
            </nav>
            <hr/>
            <nav class="navbar navbar-light bg-white  navbar-expand-md ">
                ...
                <div class="container-fluid">
                    <nav class="navbar navbar-light bg-white  navbar-expand-md">
                        ...
                        <div class="collapse navbar-collapse" id="navbarNav3">
                            ...
                            <a class="btn btn-outline-dark ml-md-3" href="javascript:;">Button</a>
                        </div>
                    </nav>
                </div>
            </header>
            <hr/>
            <nav class="navbar">
                <a class="ml-auto mr-auto" href="javascript:;">
                    <img src="http://via.placeholder.com/102x30/007bff/ffffff?text=logo" height="30" alt="image">
                </a>
            </nav>
            <hr/>
            <header class="bg-dark target-hover">
                <div class="container">
                    <nav class="navbar navbar-dark navbar-expand-md">
                        <a class="navbar-brand" href="javascript:;">
                            <img src="http://via.placeholder.com/102x30/007bff/ffffff?text=logo" height="30" alt="image">
            ...
            <header class="target-hover">
                <div class="container">
                    <nav class="navbar navbar-light bg-white  navbar-expand-md no-gutters">
                        ...
                        <div class="collapse navbar-collapse navbar-collapse-2">
                            <ul class="navbar-nav ml-auto justify-content-end">
                                <li class="nav-item">
                                    <a class="nav-link" href="javascript:;">Log In</a>
                                </li>
                            </ul>
                            <a class="btn btn-outline-dark ml-md-3" href="javascript:;">Register</a>
                        </div>
                    </nav>
                </div>
            </header>
            ...
            <nav class="navbar navbar-light bg-white  navbar-expand-md">
                <div class="container">
                    ...
                    <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNav3" aria-controls="navbarNav3" aria-expanded="true" aria-label="Toggle navigation">
                        <span class="navbar-toggler-icon"></span>
                    </button>
                    <div class="navbar-collapse collapse " id="navbarNav3" style="">
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="javascript:;">Catalog</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="javascript:;">Cart</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="javascript:;">Contact</a>
                            </li>
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="javascript:;" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <i class="fas fa-shopping-cart"></i> <span class="badge badge-pill badge-primary">5</span></a>
                                <div class="dropdown-menu dropdown-menu-right p-3" aria-labelledby="navbarDropdown" style="min-width:300px">
                                    <h6>5 Items <span class="emphasis">$147.00</span></h6>
                                    <div class="dropdown-divider"></div>
                                    <ul class="shopping-cart-items pt-2 pl-0">
                                        <li class="row mt-3">
                                            <div class="col-4">
                                                <img src="http://via.placeholder.com/50/5fa9f8/ffffff" alt="" class="img-fluid d-none d-md-block rounded mb-2 shadow ">
                                            </div>
                                            <div class="col-8">
                                                <h6>
                                                ...
                                                <span class="emphasis">$39.00</span></div>
                                        </li>
                                        <li class="row mt-3">
                                            <div class="col-4">
                                                <img src="http://via.placeholder.com/50/5fa9f8/ffffff" alt="" class="img-fluid d-none d-md-block rounded mb-2 shadow ">
                                            ...
                                            <div class="col-8">
                                                ...
                                                <span class="emphasis">$19.00</span></div>
                                        </li>
                                        <li class="row mt-3">
                                            <div class="col-4">
                                                <img src="http://via.placeholder.com/50/5fa9f8/ffffff" alt="" class="img-fluid d-none d-md-block rounded mb-2 shadow ">
                                        ...
                                        <li class="row mt-3">
                                            ...
                                            <div class="col-8">
                                                ...
                                                <span class="text-muted">1x</span>
                                                <span class="emphasis">$29.00</span></div>
                                        </li>
                                    </ul>
                                    <a href="javascript:;" class="btn btn-md btn-block btn-primary mt-3" style="margin: 0;">View Cart</a>
                                </div>
                            </li>
                        </ul>
                    </div>
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <div class="container">
                    <a class="navbar-brand mr-4" href="index.html">
                        <img src="http://via.placeholder.com/100X30/5fa9f8/efefef" alt="" style="width: 100px;">
                    </a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                        <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="javascript:;" id="dropdown19" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">Dropdown</a>
                            ...
                            <li class="nav-item mr-3">
                                <a class="nav-link" href="javascript:;">Contacts</a>
                            </li>
                        </ul>
