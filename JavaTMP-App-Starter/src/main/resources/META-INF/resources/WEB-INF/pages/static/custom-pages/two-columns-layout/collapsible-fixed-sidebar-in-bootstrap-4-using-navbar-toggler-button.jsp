...
<html lang="en">
    <head>
        <title>JavaTMP - Collapsible fixed sidebar in Bootstrap 4 Using navbar-toggler Button</title>
        <!-- Required meta tags -->
        <meta charset="utf-8">
    ...
    <body class="">
        <nav class="navbar fixed-top navbar-expand-sm navbar-dark bg-primary">
            ...
            <button class="navbar-toggler" type="button" data-toggle="collapse" data-target=".sidebar" aria-controls="navbarText" aria-expanded="false" aria-label="Collapse sidebar">
