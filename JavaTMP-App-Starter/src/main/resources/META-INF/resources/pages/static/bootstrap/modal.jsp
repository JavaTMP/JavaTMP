        ...
        <div class="col">
            <div class="card my-3">
                ...
                <div class="card-body">
                    ...
                    <!-- Button trigger modal -->
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalScrollableCenterTitle">
                        Vertically Scrollable Centered Modal
                    </button>

                    <!-- Modal -->
                    <div class="modal fade" id="exampleModalScrollableCenterTitle" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableCenterTitle" aria-hidden="true">
