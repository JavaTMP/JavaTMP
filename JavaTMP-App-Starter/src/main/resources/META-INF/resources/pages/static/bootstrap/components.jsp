    ...
    <div class="row">
        <div class="col">
            ...
            <div class="card my-3">
                ...
                <div class="card-body">
                    <h4 class="card-title text-primary">Badges scale to match the size of the immediate parent element by using relative font sizing and em units</h4>
                    ...
                    <h4 class="card-title text-primary">Badges can be used as part of links or buttons to provide a counter</h4>
                    <button type="button" class="btn btn-primary">
                        Notifications <span class="badge badge-light">4</span>
                    </button>
                    <h4 class="card-title text-primary">Contextual variations</h4>
                    ...
                    <h4 class="card-title text-primary">Pill badges</h4>
                    ...
                    <h4 class="card-title text-primary">Links</h4>
            ...
            <div class="card my-3">
                ...
                <div class="card-body">
                    <h4 class="card-title text-primary">Responsive images</h4>
            ...
            <div class="card my-3">
                ...
                <div class="card-body">
                    ...
                    <h4 class="card-title text-primary">Accordion example</h4>
                    ...
                    <h4 class="card-title text-primary">Custom markup accordions</h4>
            ...
            <div class="card my-3">
                ...
                <div class="card-body">
                    <h4 class="card-title text-primary">Default</h4>
                    <div class="jumbotron">
                    ...
                    <h4 class="card-title text-primary">Fluid Width</h4>
            ...
            <div class="card my-3">
                ...
                <div class="card-body">
                    <h4 class="card-title text-primary">Four directions</h4>
                    ...
                    <h4 class="card-title text-primary">Dismiss on next click</h4>
                    <button type="button" class="btn btn-primary" data-container="body" data-toggle="popover" data-trigger="focus" title="Dismissible popover" data-placement="top" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">
                        Popover on top
                    </button>
                    <button type="button" class="btn btn-primary" data-container="body" data-toggle="popover" data-trigger="focus" title="Dismissible popover" data-placement="right" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">
                        Popover on right
                    </button>
                    <button type="button" class="btn btn-primary" data-container="body" data-toggle="popover" data-trigger="focus" title="Dismissible popover" data-placement="bottom" data-content="Vivamus
                            sagittis lacus vel augue laoreet rutrum faucibus.">
                        Popover on bottom
                    </button>
                    <button type="button" class="btn btn-primary" data-container="body" data-toggle="popover" data-trigger="focus" title="Dismissible popover" data-placement="left" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">
                        Popover on left
                    </button>
                </div>
            </div>
            <div class="card my-3">
                ...
                <div class="card-body">
                    ...
                    <h4 class="card-title text-primary">Using <code>w-75</code></h4>
                    <div class="progress mt-3">
                        <div class="progress-bar w-75" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                    <h4 class="card-title text-primary">Labels</h4>
                    <div class="progress">
                        <div class="progress-bar" role="progressbar" style="width: 25%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">25%</div>
                    </div>
                    <h4 class="card-title text-primary">Height</h4>
                    ...
                    <h4 class="card-title text-primary">Backgrounds</h4>
                    <div class="progress mt-3">
                    ...
                    <h4 class="card-title text-primary">Multiple bars</h4>
                    <div class="progress mt-3">
                        <div class="progress-bar" role="progressbar" style="width: 15%" aria-valuenow="15" aria-valuemin="0" aria-valuemax="100"></div>
                        <div class="progress-bar bg-success" role="progressbar" style="width: 30%" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100"></div>
                        <div class="progress-bar bg-info" role="progressbar" style="width: 20%" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                    <h4 class="card-title text-primary">Striped</h4>
                    <div class="progress mt-3">
                    ...
                    <h4 class="card-title text-primary">Animated stripes</h4>
                    <div class="progress mt-3">
            ...
            <div class="card my-3">
                ...
                <div class="card-body">
                    <h4 class="card-title text-primary">Interactive demo</h4>
                    ...
                    <h4 class="card-title text-primary">Custom HTML</h4>
