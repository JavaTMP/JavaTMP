...
public class CountryTransalationService extends JpaRepository<Countrytranslation, CountrytranslationPK> {

    private Map<String, List<Countrytranslation>> countries;

    public CountryTransalationService(EntityManagerFactory emf) {
        super(Countrytranslation.class, emf);
    }
    ...
    public List<Countrytranslation> getCountries() {
        ...
        try {
            ...
            TypedQuery<Countrytranslation> query = em.createQuery(
                    "select "
                    + "new com.javatmp.module.user.entity.Countrytranslation("
