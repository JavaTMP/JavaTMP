...
<div class="dynamic-ajax-content">
    <div class="page-header">
        <h1>View Image Using Pager Bootstrap Model</h1>
    </div>
    <div class="row">
        <div class="col-lg-12">
            <div class="card my-3">
    ...
    <div class="modal" id="image-gallery" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <p class="modal-title" id="image-gallery-title"></p>
                    <button type="button" class="close" data-dismiss="modal">
                        <span aria-hidden="true">×</span><span class="sr-only">Close</span>
                    </button>
                </div>
                <div class="modal-body text-center p-1">
                    <img id="image-gallery-image" class="img-fluid" style=""
                         src="">
                </div>
        ...
        jQuery(document).ready(function () {
            (function ($) {
                ...
                function disableButtons(counter_max, counter_current) {
                    $('#show-previous-image, #show-next-image').prop("disabled", false);
                    if (counter_max === counter_current) {
                        $('#show-next-image').prop("disabled", true);
                    } else if (counter_current == 1) {
                        $('#show-previous-image').prop("disabled", true);
                    }
                }
                ...
                function loadGallery(setIDs, setClickAttr) {
                    ...
                    $(setClickAttr).on('click', function (e) {
                        e.preventDefault();
                        updateGallery($(this));
                    });
                }
