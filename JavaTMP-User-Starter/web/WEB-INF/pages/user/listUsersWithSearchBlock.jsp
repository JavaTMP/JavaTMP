                                ...
                                <div class="form-row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <input type="submit" class="btn btn-primary" value="${labels['page.btn.search']}"/>
                                            <input type="reset" class="btn btn-secondary" value="${labels['page.btn.reset']}"/>
                                        </div>
                                    </div>
                                </div>
                            </form>
