    ...
    <script type="text/javascript">
        ...
        jQuery(function ($) {
            ...
            var row = '<tr>' +
                    ...
                    '<td>{{contentType}}</td>' +
                    '<td>{{creationDate}}</td>' +
                    '<td><a class="" target="_blank" href="{{contextPath}}/ViewUploadedFileController?documentId={{link}}&amp;randomHash={{randomHash}}&amp;viewType=inline">View Inline</a></td>' +
                    '<td><a class="" target="_blank" href="{{contextPath}}/ViewUploadedFileController?documentId={{link}}&amp;randomHash={{randomHash}}&amp;viewType=attachment">View As Attachment</a></td>' +
                    '</tr>';
                    ...
                    {data: 'viewInline', name: 'viewInline',
                        "render": function (data, type, row, meta) {
                            if (type === "sort" || type === 'type' || type === 'filter') {
                                ...
                                return '<a class="" target="" href="' + javatmp.settings.contextPath + '/ViewUploadedFileController?documentId=' + row.documentId + '&amp;randomHash=' + row.randomHash + '&amp;viewType=inline">View As Attachment</a>';
                            } else {
                                return data;
                            }
                        }
                    ...
                    {data: 'viewAttachment', name: 'viewAttachment',
                        "render": function (data, type, row, meta) {
                            if (type === "sort" || type === 'type' || type === 'filter') {
                                ...
                                return '<a class="" target="" href="' + javatmp.settings.contextPath + '/ViewUploadedFileController?documentId=' + row.documentId + '&amp;randomHash=' + row.randomHash + '&amp;viewType=attachment">View As Attachment</a>';
                            } else {
                                return data;
                            }
                        }
