        ...
        <div class="col-lg-12">
            ...
            <div class="card my-3" id="table-panel">
                <div class="card-header">
                    Individual DataTables Column Searches
                    ...
                    this.api().columns().every(function (index) {
                        ...
                        if (index === 5) {
                            column.data().unique().sort().each(function (d, j) {
                                var value = numeral(d).value();
                                var display = numeral(d).format('$0,0.00');
...
//                                console.log("original data [" + data + "], converted [" + numeral(data).value() + "]");
