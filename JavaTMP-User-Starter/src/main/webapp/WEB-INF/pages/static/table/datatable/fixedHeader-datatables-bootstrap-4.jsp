        ...
        <div class="col-lg-12">
            <div class="alert alert-info mt-3">
                <p>
                    ...
                    <br/>
                    <small class="text-danger">It is not supported with fullscreen panel expanding.</small>
                </p>

                <p>
                    <a class="btn btn-info" target="_blank" href="https://datatables.net/extensions/fixedheader/">
            ...
            <div id="FixedHeader-Datatables-Panel-Id" class="card my-3">
                ...
                <div class="card-body">
                    <table width="100%" cellspacing="0" class="table table-striped table-bordered table-hover"
                           id="fixedHeader-dataTables-example">
                        <thead>
                            <tr>
                                <th>Name</th>
                                <th>Position</th>
