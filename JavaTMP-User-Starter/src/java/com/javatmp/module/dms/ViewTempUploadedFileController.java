...
@WebServlet("/dms/ViewTempUploadedFileController")
public class ViewTempUploadedFileController extends HttpServlet {
...
// obtains response's output stream
            ...
            Logger.getLogger(ViewTempUploadedFileController.class.getName()).log(Level.SEVERE, null, ex);
